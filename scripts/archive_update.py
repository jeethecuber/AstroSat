...
'''
Created by Rahul G ( on 20/04/2022 )

Run the code, provide new info, and copy and paste arranged_file.txt in czti archive page editor
...
answer = int(input("Which lightcurves ? ( Enter 1 for czti, 2 for veto,3 for both) : "))
if answer == 1:
    tbin = str(input("  enter czt binning size : "))
    cztlink = '<td class="rtecenter"><p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://www.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_{}SECBIN_lightcurves.pdf">CZTI_lightcurve</a></span></span></p>'.format(GRBname,GRBname,tbin)
    finallink = cztlink

elif answer == 2:
    vtbin = str(input("  enter veto binning size : "))
    vetolink = '<td class="rtecenter"><p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://www.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_Veto_{}SECBIN_lightcurves.pdf">Veto_lightcurve</a></span></span></p>'.format(GRBname,GRBname,vtbin)
    finallink = vetolink

elif answer == 3:
    tbin = str(input("  enter czt binning size : "))
    vtbin = str(input("  enter veto binning size : "))
    cztlink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://www.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_{}SECBIN_lightcurves.pdf">CZTI_lightcurve</a></span></span></p>'.format(GRBname,GRBname,tbin)
    vetolink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://www.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_Veto_{}SECBIN_lightcurves.pdf">Veto_lightcurve</a></span></span></p>'.format(GRBname,GRBname,vtbin)
...
if compton == 'y':
    pixt = str(input('  enter Pixel threshold : '))
    dett = str(input('  enter detector threshold : '))
    complink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://www.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_{}_{}_compton_events.pdf">Compton_lightcurve</a></span></span></p>'.format(GRBname,GRBname,pixt,dett)
...
d = open('arranged_file.txt','w')
d.write(joined)
d.close()

print(' Archive page\'s updated data is created. Please copy and paste arranged_file.txt in the archive page source code.\n')
